...
int main() {
    ...
    printf("Cards in Hand = %d, Expected = %d\n", teststate->handCount[currentPlayer] + plusOne, state->handCount[currentPlayer] + plusOne);
    myAssert(teststate->handCount[currentPlayer] + plusOne, state->handCount[currentPlayer] + plusOne);
    
    printf("Cards in Deck = %d, Expected = %d\n", teststate->deckCount[currentPlayer], state->deckCount[currentPlayer] - plusOne);
	myAssert(teststate->deckCount[currentPlayer], state->deckCount[currentPlayer] - plusOne);
	
	printf("Number of Actions = %d, Expected = %d\n", teststate->numActions, state->numActions + plusTwo);
	myAssert(teststate->numActions, state->numActions + plusTwo);
